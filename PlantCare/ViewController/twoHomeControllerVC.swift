...
class twoHomeControllerVC: UIViewController ,UICollectionViewDelegate,
  ...
  var arrPhotos : [ShowPlant] = [ShowPlant(image: UIImage(named: "2656")!, step: "Water plants regularly."), ShowPlant(image: UIImage(named: "Peony")!, step: "Check the soil moisture"), ShowPlant(image: UIImage(named: "46574")!, step: "Pour water at room temperature."),
  ShowPlant(image: UIImage(named: "1323")!, step: "Give some sunlight or artificial light to plants."), ShowPlant(image: UIImage(named: "CherryTree")!, step: "Use humidifier to maintain surroundings."), ShowPlant(image: UIImage(named: "Parlor")!, step: "Add fertilizers to the pot to provide nutrients to plant."), ShowPlant(image: UIImage(named: "Elkhorn Fern")!, step: "Prune your plant regularly.")]
